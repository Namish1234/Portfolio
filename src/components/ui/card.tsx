        ...
        const PlusIcons = () => (
            <>
                <svg
                    ...
                    strokeWidth="1"
                    stroke="currentColor"
                    className="dark:text-white text-black size-6 absolute -top-3 -left-3 bg-background"
                >
                ...
                <svg
                    ...
                    strokeWidth="1"
                    stroke="currentColor"
                    className="dark:text-white text-black size-6 absolute -top-3 -right-3 bg-background"
                >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m6-6H6" />
                </svg>
                <svg
                    ...
                    strokeWidth="1"
                    stroke="currentColor"
                    className="dark:text-white text-black size-6 absolute -bottom-3 -left-3 bg-background"
                >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m6-6H6" />
                </svg>
                <svg
                    ...
                    strokeWidth="1"
                    stroke="currentColor"
                    className="dark:text-white text-black size-6 absolute -bottom-3 -right-3 bg-background"
                >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m6-6H6" />
                </svg>
            </>
